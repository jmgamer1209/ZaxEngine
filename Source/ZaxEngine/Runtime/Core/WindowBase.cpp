...
void WindowBase::LoadFont()
{
	...
	auto fontPath = Utils::GetEngineContentDirectory() / "Fonts" / "SourceHanSansSC-Regular.otf";
    ImFont* font = io.Fonts->AddFontFromFileTTF(fontPath.generic_string().c_str(), 22.0f);
